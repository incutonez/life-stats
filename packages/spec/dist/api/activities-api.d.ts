...
import { ExerciseActivityTypeViewModel } from '../models';
...
export declare const ActivitiesApiFp: (configuration?: Configuration) => {
    ...
    getActivityTypes(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ExerciseActivityTypeViewModel>>>;
    importStravaActivities(file: File, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ExerciseActivityCreateViewModel>>>;
...
export declare const ActivitiesApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    ...
    getActivityTypes(options?: any): AxiosPromise<Array<ExerciseActivityTypeViewModel>>;
    importStravaActivities(file: File, options?: any): AxiosPromise<Array<ExerciseActivityCreateViewModel>>;
...
export interface ActivitiesApiInterface {
    ...
    getActivityTypes(options?: AxiosRequestConfig): AxiosPromise<Array<ExerciseActivityTypeViewModel>>;
    importStravaActivities(file: File, options?: AxiosRequestConfig): AxiosPromise<Array<ExerciseActivityCreateViewModel>>;
...
export declare class ActivitiesApi extends BaseAPI implements ActivitiesApiInterface {
    ...
    getActivityTypes(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ExerciseActivityTypeViewModel[], any>>;
    importStravaActivities(file: File, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ExerciseActivityCreateViewModel[], any>>;
