...
export declare const ActivitiesApiAxiosParamCreator: (configuration?: Configuration) => {
    ...
    uploadStravaActivities: (activityCreateViewModel: Array<ActivityCreateViewModel>, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
export declare const ActivitiesApiFp: (configuration?: Configuration) => {
    ...
    uploadStravaActivities(activityCreateViewModel: Array<ActivityCreateViewModel>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
};
...
export declare class ActivitiesApi extends BaseAPI implements ActivitiesApiInterface {
    ...
    uploadStravaActivities(activityCreateViewModel: Array<ActivityCreateViewModel>, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<object, any>>;
}
