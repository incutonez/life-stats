...
export declare const ApplicationsApiAxiosParamCreator: (configuration?: Configuration) => {
    ...
    createApplications: (requestBody: Array<string>, options?: AxiosRequestConfig) => Promise<RequestArgs>;
...
export declare const ApplicationsApiFp: (configuration?: Configuration) => {
    ...
    createApplications(requestBody: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
...
export declare class ApplicationsApi extends BaseAPI implements ApplicationsApiInterface {
    ...
    createApplications(requestBody: Array<string>, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object, any>>;
